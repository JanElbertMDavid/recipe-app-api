...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email="user@exapmle.com", password="test123")
    ...
    def test_delete_recipe(self):
        # Test deleting a recupe successful
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        actual_user = create_user(
            email="user1@example.com",
            password="test456"
        )
        recipe = create_recipe(user=actual_user)
        new_user = create_user(email="user2@example.com", password="test123")
    ...
    def test_create_recipe_with_existing_tag(self):
        '''Test creatomg a recipe with an existing tag.'''
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('15.00'),
            'ingredients': [{'name': 'Cocoa'}, {'name': 'Flour'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
